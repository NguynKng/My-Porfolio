  ...
  return (
    <footer className="site-footer">
      <div className="section-shell footer-inner">
        <div className="footer-brand"><Link className="wordmark" to="/" state={{ scrollTo: "HOME" }}>nguynkng</Link><span>Full-stack Developer</span></div>
      ...
      <p className="section-shell copyright">&copy; {new Date().getFullYear()} nguynkng. All rights reserved.</p>
    </footer>
  );
}
